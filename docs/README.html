...
<p>
    View the <a href="images/ScreenshotDockerContainers.png">screenshot</a> of the created Docker containers.
</p>
...
<ul>
    <li>View the <a href="images/ScreenshotKeycloakROLE_OFFICIAL.png">screenshot</a> of the 'ROLE_OFFICIAL' settings.</li>
    <li>View the <a href="images/ScreenshotKeycloakROLE_RESTRICTED.png">screenshot</a> of the 'ROLE_RESTRICTED' settings.</li>
    <li>View the <a href="images/ScreenshotKeycloakROLE_CONFIDENTIAL.png">screenshot</a> of the 'ROLE_CONFIDENTIAL' settings.</li>
    <li>View the <a href="images/ScreenshotKeycloakROLE_SECRET.png">screenshot</a> of the 'ROLE_SECRET' settings.</li>
    <li>View the <a href="images/ScreenshotKeycloakUsers.png">screenshot</a> of the 'Users' settings.</li>
    <li>View the <a href="images/ScreenshotKeycloakUsersRoleMapping.png">screenshot</a> of the 'Users Role Mapping' settings.</li>
</ul>
...
<p><img  alt="" src="images/greenCircle.png">
    4.1. View the <a href="images/ScreenshotCurlLocal.png">screenshot</a> of the console log
    from the batch file "04 CURL on local.bat".<br>
</p>
...
<p>Action:<br>
    <img  alt="" src="images/orangeHR-500.png"><br>
    <img alt="" src="images/orangeSquare.png"> 1. Open the file
    <a href="https://github.com/k1729p/Study23/blob/main/0_batch/Links.html">Links.html</a> in a web browser.<br>
    <img  alt="" src="images/orangeHR-500.png">
</p>

<p><img  alt="" src="images/greenCircle.png">
    5.1. View the GitHub preview in a browser of the page
    <a href="https://htmlpreview.github.io/?https://github.com/k1729p/Study23/blob/main/0_batch/Links.html">
        Links</a>.
</p>
<p><img  alt="" src="images/greenCircle.png">
    5.2. View the <a href="images/ScreenshotKeycloakLoginAuthentication.png">screenshot</a>
    of Keycloak's login authentication page.
</p>
...
<p>
    View the <a href="images/ScreenshotOfficialDocument.png">screenshot</a> of the result
    from the endpoint 'http://localhost:9091/api/document/official/html'.
</p>
<p>
    The service method:
...
<p>
    View the <a href="images/ScreenshotRestrictedDocument.png">screenshot</a> of the result
    from the endpoint 'http://localhost:9091/api/document/restricted/html'.<br>
</p>
...
<p>
    View the <a href="images/ScreenshotConfidentialDocument.png">screenshot</a> of the result
    from the endpoint 'http://localhost:9091/api/document/confidential/html'.<br>
</p>
...
<p>
    View the <a href="images/ScreenshotSecretDocument.png">screenshot</a> of the result
    from the endpoint 'http://localhost:9091/api/document/secret/html'.<br>
</p>
...
<p>
    View the <a href="images/ScreenshotGateway.png">screenshot</a> of the result
    from the endpoint 'http://localhost:9091/'.<br>
</p>
...
<p>
    View the <a href="images/ScreenshotGatewayInformation.png">screenshot</a> of the result
    from the endpoint 'http://localhost:9091/info'.<br>
</p>
...
<p>
    View the <a href="images/ScreenshotResourceServerInformation.png">screenshot</a> of the result
    from the endpoint 'http://localhost:9091/api/info'.<br>
</p>
